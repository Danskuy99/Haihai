...
<body>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       ...
       <!-- Pesan -->
       <p id="pesan3">Ciee.. kita anniversary Nih 🤣❤️</p>
       <p id="pesan4">Happy Anniversary, </p>
       <p id="pesan5" class="gaya2">Nambah langgeng ya sama accuw, hehe</p>
       <p id="pesan6" class="gaya2">Moga panjang umur ayang accuw biar tiap tahun bisa traktirin aku wkwk 😆❤️</p>
       <p id="pesan7" class="gaya2">Sehat selalu ya!</p>

       <p id="pesan8" class="gaya2">Canda wkwwk :v</p>
       <p id="pesan9" class="gaya2">Oh iya, semoga di hari spesialmu kita ini kamu dapat menjadi pribadi yang lebih baik yaa.. 🥳❤️</p>
       <p id="pesan10" class="gaya2">Happy Anniversary 6th Dear!! 🥳</p>
...
<script>
  ...
  var tomnegatif = 'Engga';
    ...
    async function menuju(){pesanwhatsapp = "Makasii udah ngucapin " + nama + " ultah ><";await swals.fire('OK!', 'Kirim jawabannya ke WhatsApp aku, ya!', 'success');window.location = "https://api.whatsapp.com/send?phone=+6285691329141&text=" + pesanwhatsapp;}
</script>
